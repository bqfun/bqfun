...
### [GMO アドマーケティング株式会社](https://www.gmo-am.jp/)
- [BigQuery や TensorFlow などの先進的機能に惹かれ Google Cloud Platform を採用](https://cloud.google.com/blog/ja/topics/customers/gmo-bigquery-tensorflow-google-cloud-platform)
...
### [K4 Digital株式会社](https://k4digital.jp/)
- [デジタル トランスフォーメーション推進に変化に強く柔軟な GCP を採用。BigQuery を中心とした GCP プロダクトを活用した新しい基盤を構築](https://cloud.google.com/blog/ja/topics/customers/k4-digital-gcp-bigquery)
...
- [BigQuery から Partner Interconnect まで、各種 GCP プロダクトを駆使して次世代マーケティング プラットフォーム『ASKUL EARTH』を構築](https://cloud.google.com/blog/ja/topics/customers/bigquery-partner-interconnect-gcp-askul-earth)
...
- [BigQuery の導入でデータサイエンティストが “価値ある仕事” に集中できるように](https://cloud.google.com/blog/ja/topics/customers/bigquery_17)
- [BigQuery の導入で煩雑な業務から解放、運用にパラダイムシフトを](https://cloud.google.com/blog/ja/topics/customers/google-cloud-platform-bigquery-sonynetwork)
...
### [株式会社MonotaRO](https://corp.monotaro.com/overview.html)
- [BigQuery を駆使した新しいデータ分析基盤構築で、全社的にさらなるデータ活用を推進](https://cloud.google.com/blog/ja/topics/customers/monotaro-bigquery)
...
- [Stackdriver Logging でのログ監視や、BigQuery を駆使した分析・活用などにより、SLO 99.95% を達成](https://cloud.google.com/blog/ja/topics/customers/eureka-stackdriver-logging-bigquery)
...
- [マネーフォワードの Fintech サービスを GCP が強力にサポート。BigQuery と GCS でログ解析の効率化とコスト削減を実現。](https://cloud.google.com/blog/ja/topics/customers/moneyforward-fintech-gcp-bigquery-gcs)
